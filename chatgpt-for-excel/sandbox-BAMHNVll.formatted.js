var ZI = (C, U) => () => (U || C((U = { exports: {} }).exports, U), U.exports);
import {
  D as fA,
  O as LI,
  g as WI,
  ...
  p as II,
  q as Cg,
} from "./officejs-sandbox-protocol-DHHFLCK9.js";
var rg = ZI((fg, j) => {
  try {
    (function () {
      var C =
      ...
      U &&
        ...
        (C._sentryDebugIds[U] = "4aba8757-efb9-48f1-969a-a93c8494e1aa"),
        (C._sentryDebugIdIdentifier =
          "sentry-dbid-4aba8757-efb9-48f1-969a-a93c8494e1aa"));
    })();
  } catch {}
  function Qg(C, U = { defaultLimits: fA, serializedRefKey: LI }) {
    const h = { ...U.defaultLimits, ...C.limits },
      G = new Map(),
      k = new Map(),
      A = new Map(),
      c = new WeakMap(),
    ...
    function Q(t) {
      ...
      const Y = Object.getPrototypeOf(t);
    ...
    function s(t) {
      if (!(typeof t > "u")) return D(t);
    }
    function g(t) {
      if (I > h.maxObjectIds)
        throw new Error(
          `run_officejs exceeded the sandbox object limit (${h.maxObjectIds}).`,
        );
      const Y = I;
      return ((I += 1), G.set(Y, { ...t, id: Y }), Y);
    }
    const B = g({ kind: "root", root: "ctx" }),
      o = g({ kind: "root", root: "excel" });
    function R(t) {
      return (
    ...
    function J(t) {
      return R(t) ? (c.get(t) ?? null) : null;
    }
    function H(t) {
      const Y = J(t);
      if (Y != null) return { [U.serializedRefKey]: Y };
      ...
      if (Array.isArray(t)) return t.map((i) => H(i));
      if (Q(t)) {
        const i = {};
        for (const [M, S] of Object.entries(t)) typeof S > "u" || (i[M] = H(S));
        return i;
      }
      throw new Error(
    ...
    function p(t) {
      ...
      const i = k.get(Y);
      return typeof i < "u" ? D(i) : `[OfficejsProxy ${Y}]`;
    }
    function q(t) {
    ...
    function Z(t) {
      return Array.isArray(t)
        ? t.every(Array.isArray)
          ? t.reduce((Y, i) => Y + i.length, 0)
          : t.length
        : 0;
    }
    function P(t, Y, i) {
      const M = k.get(t),
        S = Q(M) && !Array.isArray(M) ? { ...M, [Y]: D(i) } : { [Y]: D(i) };
      k.set(t, S);
      const n = N.get(t),
        f = n == null ? void 0 : n.get(Y);
      typeof f == "number" && k.set(f, D(i));
    }
    function v(t) {
      if (a.length >= h.maxQueuedOperations)
        throw new Error(
          `run_officejs exceeded the queued operation limit (${h.maxQueuedOperations}) before calling ctx.sync().`,
        );
      if (JSON.stringify(t).length > h.maxSerializedChars)
        throw new Error(
          `run_officejs produced an operation payload larger than the sandbox limit (${h.maxSerializedChars} chars).`,
        );
      if (t.kind === "set") {
        const i = t.property.toLowerCase();
        if (
          (i === "value" ||
            i === "values" ||
            i === "formula" ||
            ...
            i === "numberformat" ||
            i === "numberformats") &&
          Z(t.value) > h.maxMatrixWriteCells
        )
          throw new Error(
            `run_officejs write payload exceeds the matrix cell limit (${h.maxMatrixWriteCells} cells).`,
          );
      }
      a.push(t);
    }
    function W(t, Y) {
      ...
      const M = i.get(Y);
      if (typeof M == "number") return AA(M);
      const S = g({ kind: "property", parentId: t, property: Y });
      return (i.set(Y, S), AA(S));
    }
    function V(t) {
    ...
    async function oA() {
      ...
      const Y = {
          requestId: t,
          definitions: Array.from(G.values()),
          commands: a.splice(0, a.length),
        },
        i = await C.callHost(Y);
      if (!i || i.requestId !== t)
        throw new Error(
          "run_officejs sandbox received an invalid sync response.",
        );
      V(i.snapshots);
    }
    function T(t) {
      ...
      const i = function () {},
        M = new Proxy(i, {
          get: (S, n) => {
            ...
            if (n === "load")
              return (...d) => {
                const b = d.length <= 1 ? H(d[0] ?? null) : H(d);
                return (v({ kind: "load", targetId: t, spec: b }), M);
              };
            if (t === B && n === "sync") return oA;
            if (n === "toJSON") return () => s(k.get(t)) ?? {};
            if (n === "valueOf") return () => BA(t);
            if (n === Symbol.toPrimitive) return () => BA(t);
            if (n === Symbol.toStringTag) return "OfficejsSandboxProxy";
            if (typeof n != "string") return;
            const f = k.get(t),
              r = (l = N.get(t)) == null ? void 0 : l.get(n);
            if (
              Q(f) &&
              !Array.isArray(f) &&
              ...
              const d = f[n];
              return typeof r == "number" && Q(d) && !Array.isArray(d)
                ? AA(r)
                : D(d);
            }
            return W(t, n);
          ...
          set: (S, n, f) => {
            ...
            const r = H(f);
            return (
              v({ kind: "set", targetId: t, property: n, value: r }),
              P(t, n, r),
              !0
            );
          },
          apply: (S, n, f) => {
            const r = G.get(t);
            if (!r || r.kind !== "property")
              throw new Error(
                "Only Office member proxies can be invoked as functions.",
              );
            const l = Array.isArray(f) ? f.map((b) => H(b)) : [],
              d = g({
                kind: "invoke",
                parentId: r.parentId,
                method: r.property,
  ...
  function Bg(C, U = fA) {
    const h = Qg.toString(),
      G = JSON.stringify(U),
      k = JSON.stringify({ defaultLimits: fA, serializedRefKey: LI });
    return `
(() => {
  const __name = (target, _value) => target;
  const __createOfficejsSandboxGuestRuntime = (${h});
  const __guestRuntimeStaticConfig = ${k};
...
`;
  ...
  function Eg() {
    ...
    ((gI = 1),
      ...
      (sA.unwrapJavascript = sA.unwrapTypescript = void 0));
    function C(h) {
      return h.default;
    }
    function U(h) {
    ...
    return ((sA.unwrapTypescript = U), (sA.unwrapJavascript = C), sA);
  }
  var j = {},
    ZA = {},
    CI;
      ...
      CI ||
        ...
        (function (C) {
          ...
          (Object.defineProperty(C, "__esModule", { value: !0 }),
            (C.debugLog = C.QTS_DEBUG = void 0),
            (C.QTS_DEBUG = !!(typeof process == "object" && U.QTS_DEBUG)),
            (C.debugLog = C.QTS_DEBUG ? console.log.bind(console) : () => {}));
        })(ZA)),
      ZA
    );
  }
  ...
  function yA() {
    ...
    ((QI = 1),
      ...
      (X.QuickJSMemoryLeakDetected =
        X.QuickJSAsyncifySuspended =
        X.QuickJSAsyncifyError =
        X.QuickJSNotImplemented =
        X.QuickJSUseAfterFree =
        X.QuickJSWrongOwner =
        X.QuickJSUnwrapError =
          void 0));
  ...
  function HI() {
    ...
    ((BI = 1),
      ...
      (DA.awaitEachYieldedPromise = DA.maybeAsync = DA.maybeAsyncFn = void 0));
    function* C(c) {
      return yield c;
    }
    function U(c) {
    ...
    return ((DA.awaitEachYieldedPromise = A), DA);
  }
  var EI;
  function MA() {
    if (EI) return CA;
    ((EI = 1),
      ...
      (CA.Scope = CA.WeakLifetime = CA.StaticLifetime = CA.Lifetime = void 0));
    const C = HI(),
      U = LA(),
      h = yA();
    class G {
      constructor(I, w, Q, D) {
        ((this._value = I),
          ...
          (this._owner = D),
          (this._alive = !0),
          (this._constructorStack = U.QTS_DEBUG
      ...
      assertAlive() {
        if (!this.alive)
          throw this._constructorStack
            ? new h.QuickJSUseAfterFree(`Lifetime not alive
    ...
    function c(a, I) {
      ...
      if (I && w)
        throw (
          Object.assign(I, {
            message: `${I.message}
 Then, failed to dispose scope: ${w.message}`,
            disposeError: w,
          }),
          I
        );
    ...
    class N {
      constructor() {
        this._disposables = new G(new Set());
      }
      static withScope(I) {
        const w = new N();
        let Q;
      ...
      static withScopeMaybeAsync(I, w) {
        return (0, C.maybeAsync)(void 0, function* (Q) {
          const D = new N();
          let s;
          try {
            return yield* Q.of(w.call(I, Q, D));
          } catch (g) {
            throw ((s = g), g);
          } finally {
            c(D, s);
      ...
      manage(I) {
        return (this._disposables.value.add(I), I);
      }
      get alive() {
        return this._disposables.alive;
      }
      dispose() {
        const I = Array.from(this._disposables.value.values()).reverse();
        for (const w of I) w.alive && w.dispose();
        this._disposables.dispose();
      }
    }
    return ((CA.Scope = N), CA);
  }
  var kA = {},
    UA = {},
    aA = {},
  ...
  function YI() {
    ...
    ((DI = 1),
      ...
      (aA.QuickJSDeferredPromise = void 0));
    class C {
      constructor(h) {
        ((this.resolve = (G) => {
          ...
          (this.owner = h.context.runtime),
          (this.handle = h.promiseHandle),
          (this.settled = new Promise((G) => {
            this.onSettled = G;
          })),
          (this.resolveHandle = h.resolveHandle),
          (this.rejectHandle = h.rejectHandle));
      }
      get alive() {
        return (
          this.handle.alive ||
    ...
    return ((aA.QuickJSDeferredPromise = C), aA);
  }
  var eA = {},
    iI;
  function rI() {
    ...
    class U {
      ...
      toPointerArray(G) {
        const k = new Int32Array(G.map((a) => a.value)),
          A = k.length * k.BYTES_PER_ELEMENT,
          c = this.module._malloc(A);
        var N = new Uint8Array(this.module.HEAPU8.buffer, c, A);
        return (
          N.set(new Uint8Array(k.buffer)),
          new C.Lifetime(c, void 0, (a) => this.module._free(a))
        );
      }
      newMutablePointerArray(G) {
        const k = new Int32Array(new Array(G).fill(0)),
          A = k.length * k.BYTES_PER_ELEMENT,
          c = this.module._malloc(A),
          N = new Int32Array(this.module.HEAPU8.buffer, c, G);
        return (
          N.set(k),
          new C.Lifetime({ typedArray: N, ptr: c }, void 0, (a) =>
            this.module._free(a.ptr),
          )
        );
      }
      newHeapCharPointer(G) {
        const k = this.module.lengthBytesUTF8(G) + 1,
          A = this.module._malloc(k);
        return (
          this.module.stringToUTF8(G, A, k),
          new C.Lifetime(A, void 0, (c) => this.module._free(c))
        );
      }
      consumeHeapCharPointer(G) {
        const k = this.module.UTF8ToString(G);
        return (this.module._free(G), k);
      }
    }
    return ((eA.ModuleMemory = U), eA);
  }
  var iA = {},
    RA = {},
    wI;
  function Dg() {
    ...
    ((wI = 1),
      ...
      (RA.EvalFlags = RA.assertSync = void 0));
    function C(U) {
      return function (...G) {
        const k = U(...G);
        if (k && typeof k == "object" && k instanceof Promise)
  ...
  function HA() {
    ...
    ((oI = 1),
      ...
      (iA.concat = iA.evalOptionsToFlags = iA.DefaultIntrinsics = void 0));
    const C = Dg();
    iA.DefaultIntrinsics = Symbol("DefaultIntrinsics");
    function U(G) {
      ...
      let I = 0;
      return (
        k === "global" && (I |= C.EvalFlags.JS_EVAL_TYPE_GLOBAL),
        k === "module" && (I |= C.EvalFlags.JS_EVAL_TYPE_MODULE),
        A && (I |= C.EvalFlags.JS_EVAL_FLAG_STRICT),
        c && (I |= C.EvalFlags.JS_EVAL_FLAG_STRIP),
        N && (I |= C.EvalFlags.JS_EVAL_FLAG_COMPILE_ONLY),
        a && (I |= C.EvalFlags.JS_EVAL_FLAG_BACKTRACE_BARRIER),
        I
      );
    }
    iA.evalOptionsToFlags = U;
    function h(...G) {
      let k = [];
      for (const A of G) A !== void 0 && (k = k.concat(A));
      return k;
    }
    return ((iA.concat = h), iA);
  }
  var FI;
  function lI() {
    if (FI) return UA;
    ...
    const C = LA(),
      ...
      k = rI(),
      A = HA();
    class c extends k.ModuleMemory {
      constructor(I) {
        var w;
        (super(I.module),
          (this.scope = new G.Scope()),
          (this.copyJSValue = (Q) =>
            this.ffi.QTS_DupValuePointer(this.ctx.value, Q)),
          (this.freeJSValue = (Q) => {
            this.ffi.QTS_FreeValuePointer(this.ctx.value, Q);
          }),
          (w = I.ownedLifetimes) == null ||
            w.forEach((Q) => this.scope.manage(Q)),
          (this.owner = I.owner),
      ...
      consumeJSCharPointer(I) {
        const w = this.module.UTF8ToString(I);
        return (this.ffi.QTS_FreeCString(this.ctx.value, I), w);
      }
      heapValueHandle(I) {
        return new G.Lifetime(
          I,
          this.copyJSValue,
          this.freeJSValue,
          this.owner,
    ...
    class N {
      constructor(I) {
        ((this._undefined = void 0),
          ...
          (this.cToHostCallbacks = {
            callFunction: (w, Q, D, s, g) => {
              if (w !== this.ctx.value)
                throw new Error(
                  "QuickJSContext instance received C -> JS call with mismatched ctx",
                );
              const B = this.getFunction(g);
              if (!B)
                throw new Error(`QuickJSContext had no callback with id ${g}`);
              return G.Scope.withScopeMaybeAsync(this, function* (o, R) {
                const J = R.manage(
                    new G.WeakLifetime(
                      Q,
                  ...
                  H = new Array(D);
                for (let K = 0; K < D; K++) {
                  const p = this.ffi.QTS_ArgvGetJSValueConstPointer(s, K);
                  H[K] = R.manage(
                    new G.WeakLifetime(
                      p,
                      this.memory.copyJSValue,
                ...
                try {
                  const K = yield* o(B.apply(J, H));
                  if (K) {
                    if ("error" in K && K.error)
                      throw ((0, C.debugLog)("throw error", K.error), K.error);
                    const p = R.manage(K instanceof G.Lifetime ? K : K.value);
                  ...
                  return this.errorToHandle(K).consume((p) =>
                    this.ffi.QTS_Throw(this.ctx.value, p.value),
                  );
                }
              });
            },
          ...
          (this.rt = I.rt),
          (this.ctx = I.ctx),
          (this.memory = new c({ ...I, owner: this.runtime })),
          I.callbacks.setContextCallbacks(
            this.ctx.value,
            this.cToHostCallbacks,
          ),
      ...
      get undefined() {
        ...
        const I = this.ffi.QTS_GetUndefined();
        return (this._undefined = new G.StaticLifetime(I));
      }
      get null() {
        if (this._null) return this._null;
        const I = this.ffi.QTS_GetNull();
        return (this._null = new G.StaticLifetime(I));
      }
      get true() {
        if (this._true) return this._true;
        const I = this.ffi.QTS_GetTrue();
        return (this._true = new G.StaticLifetime(I));
      }
      get false() {
        if (this._false) return this._false;
        const I = this.ffi.QTS_GetFalse();
        return (this._false = new G.StaticLifetime(I));
      }
      get global() {
        if (this._global) return this._global;
        const I = this.ffi.QTS_GetGlobalObject(this.ctx.value);
        return (
          this.memory.manage(this.memory.heapValueHandle(I)),
          (this._global = new G.StaticLifetime(I, this.runtime)),
          this._global
        );
      }
      newNumber(I) {
        return this.memory.heapValueHandle(
          this.ffi.QTS_NewFloat64(this.ctx.value, I),
        );
      }
      newString(I) {
        const w = this.memory
          .newHeapCharPointer(I)
          .consume((Q) => this.ffi.QTS_NewString(this.ctx.value, Q.value));
        return this.memory.heapValueHandle(w);
      }
      newUniqueSymbol(I) {
        const w = (typeof I == "symbol" ? I.description : I) ?? "",
          Q = this.memory
            .newHeapCharPointer(w)
            .consume((D) => this.ffi.QTS_NewSymbol(this.ctx.value, D.value, 0));
        return this.memory.heapValueHandle(Q);
      }
      newSymbolFor(I) {
        const w = (typeof I == "symbol" ? I.description : I) ?? "",
          Q = this.memory
            .newHeapCharPointer(w)
            .consume((D) => this.ffi.QTS_NewSymbol(this.ctx.value, D.value, 1));
        return this.memory.heapValueHandle(Q);
      }
      newBigInt(I) {
        if (!this._BigInt) {
          const D = this.getProp(this.global, "BigInt");
          (this.memory.manage(D),
            (this._BigInt = new G.StaticLifetime(D.value, this.runtime)));
        }
        const w = this._BigInt,
          Q = String(I);
        return this.newString(Q).consume((D) =>
          this.unwrapResult(this.callFunction(w, this.undefined, D)),
        );
      }
      newObject(I) {
      ...
      newArray() {
        const I = this.ffi.QTS_NewArray(this.ctx.value);
        return this.memory.heapValueHandle(I);
      }
      newPromise(I) {
        const w = G.Scope.withScope((Q) => {
          const D = Q.manage(this.memory.newMutablePointerArray(2)),
            s = this.ffi.QTS_NewPromiseCapability(this.ctx.value, D.value.ptr),
            g = this.memory.heapValueHandle(s),
            [B, o] = Array.from(D.value.typedArray).map((R) =>
              this.memory.heapValueHandle(R),
            );
          return new U.QuickJSDeferredPromise({
            context: this,
            promiseHandle: g,
            resolveHandle: B,
            rejectHandle: o,
        ...
        return (
          ...
          I &&
            Promise.resolve(I).then(w.resolve, (Q) =>
              Q instanceof G.Lifetime
                ? w.reject(Q)
                : this.newError(Q).consume(w.reject),
            ),
          w
        );
      }
      newFunction(I, w) {
        const Q = ++this.fnNextId;
        return (
          this.setFunction(Q, w),
          this.memory.heapValueHandle(
            this.ffi.QTS_NewFunction(this.ctx.value, Q, I),
          )
        );
      }
      newError(I) {
        const w = this.memory.heapValueHandle(
          this.ffi.QTS_NewError(this.ctx.value),
        );
        return (
          I && typeof I == "object"
            ? (I.name !== void 0 &&
                this.newString(I.name).consume((Q) =>
                  this.setProp(w, "name", Q),
                ),
              I.message !== void 0 &&
                this.newString(I.message).consume((Q) =>
                  this.setProp(w, "message", Q),
                ))
            : typeof I == "string"
              ? this.newString(I).consume((Q) => this.setProp(w, "message", Q))
              : I !== void 0 &&
                this.newString(String(I)).consume((Q) =>
                  this.setProp(w, "message", Q),
                ),
          w
        );
      ...
      typeof(I) {
        return (
          ...
          this.memory.consumeHeapCharPointer(
            this.ffi.QTS_Typeof(this.ctx.value, I.value),
          )
        );
      }
      getNumber(I) {
        return (
          this.runtime.assertOwned(I),
          this.ffi.QTS_GetFloat64(this.ctx.value, I.value)
        );
      }
      getString(I) {
        return (
          ...
          this.memory.consumeJSCharPointer(
            this.ffi.QTS_GetString(this.ctx.value, I.value),
          )
        );
      }
      getSymbol(I) {
        this.runtime.assertOwned(I);
        const w = this.memory.consumeJSCharPointer(
          this.ffi.QTS_GetSymbolDescriptionOrKey(this.ctx.value, I.value),
        );
        return this.ffi.QTS_IsGlobalSymbol(this.ctx.value, I.value)
          ? Symbol.for(w)
          : Symbol(w);
      }
      getBigInt(I) {
        this.runtime.assertOwned(I);
        const w = this.getString(I);
        return BigInt(w);
      }
      resolvePromise(I) {
        this.runtime.assertOwned(I);
        const w = G.Scope.withScope((Q) => {
          const D = Q.manage(this.getProp(this.global, "Promise")),
            s = Q.manage(this.getProp(D, "resolve"));
          return this.callFunction(s, D, I);
        });
        return w.error
          ? Promise.resolve(w)
          : new Promise((Q) => {
              G.Scope.withScope((D) => {
                const s = D.manage(
                    this.newFunction("resolve", (R) => {
                      Q({ value: R && R.dup() });
                    }),
                  ),
                  g = D.manage(
                    this.newFunction("reject", (R) => {
                      Q({ error: R && R.dup() });
                    }),
                  ),
                  B = D.manage(w.value),
                  o = D.manage(this.getProp(B, "then"));
                this.unwrapResult(this.callFunction(o, B, s, g)).dispose();
              });
            });
      }
      getProp(I, w) {
        this.runtime.assertOwned(I);
        const Q = this.borrowPropertyKey(w).consume((s) =>
          this.ffi.QTS_GetProp(this.ctx.value, I.value, s.value),
        );
        return this.memory.heapValueHandle(Q);
      }
      setProp(I, w, Q) {
        (this.runtime.assertOwned(I),
          this.borrowPropertyKey(w).consume((D) =>
            this.ffi.QTS_SetProp(this.ctx.value, I.value, D.value, Q.value),
          ));
      }
      defineProp(I, w, Q) {
        (this.runtime.assertOwned(I),
          G.Scope.withScope((D) => {
            const s = D.manage(this.borrowPropertyKey(w)),
              g = Q.value || this.undefined,
              B = !!Q.configurable,
              o = !!Q.enumerable,
              R = !!Q.value,
              J = Q.get
                ? D.manage(this.newFunction(Q.get.name, Q.get))
                : this.undefined,
              H = Q.set
                ? D.manage(this.newFunction(Q.set.name, Q.set))
                : this.undefined;
      ...
      callFunction(I, w, ...Q) {
        ...
        const D = this.memory
          ...
          s = this.ffi.QTS_ResolveException(this.ctx.value, D);
        return s
          ? (this.ffi.QTS_FreeValuePointer(this.ctx.value, D),
            { error: this.memory.heapValueHandle(s) })
          : { value: this.memory.heapValueHandle(D) };
      }
      evalCode(I, w = "eval.js", Q) {
        const D = Q === void 0 ? 1 : 0,
          s = (0, A.evalOptionsToFlags)(Q),
          g = this.memory
            .newHeapCharPointer(I)
            .consume((o) =>
              this.ffi.QTS_Eval(this.ctx.value, o.value, w, D, s),
            ),
          B = this.ffi.QTS_ResolveException(this.ctx.value, g);
        return B
          ? (this.ffi.QTS_FreeValuePointer(this.ctx.value, g),
            { error: this.memory.heapValueHandle(B) })
          : { value: this.memory.heapValueHandle(g) };
      }
      throw(I) {
        return this.errorToHandle(I).consume((w) =>
          this.ffi.QTS_Throw(this.ctx.value, w.value),
        );
      }
      borrowPropertyKey(I) {
        return typeof I == "number"
          ...
          : typeof I == "string"
            ? this.newString(I)
            : new G.StaticLifetime(I.value, this.runtime);
      }
      getMemory(I) {
      ...
      dump(I) {
        this.runtime.assertOwned(I);
        const w = this.typeof(I);
        if (w === "string") return this.getString(I);
        if (w === "number") return this.getNumber(I);
        if (w === "bigint") return this.getBigInt(I);
        if (w === "undefined") return;
        if (w === "symbol") return this.getSymbol(I);
        const Q = this.memory.consumeJSCharPointer(
          this.ffi.QTS_Dump(this.ctx.value, I.value),
        );
        try {
          return JSON.parse(Q);
        } catch {
      ...
      unwrapResult(I) {
        if (I.error) {
          const w = "context" in I.error ? I.error.context : this,
            Q = I.error.consume((D) => this.dump(D));
          if (Q && typeof Q == "object" && typeof Q.message == "string") {
            const { message: D, name: s, stack: g } = Q,
              B = new h.QuickJSUnwrapError(""),
              o = B.stack;
            throw (
              typeof s == "string" && (B.name = Q.name),
              typeof g == "string" &&
                (B.stack = `${s}: ${D}
${Q.stack}Host: ${o}`),
              Object.assign(B, { cause: Q, context: w, message: D }),
              B
            );
          }
          throw new h.QuickJSUnwrapError(Q, w);
        }
        return I.value;
      }
      getFunction(I) {
      ...
      setFunction(I, w) {
        const Q = I >> 8;
        let D = this.fnMaps.get(Q);
        return (D || ((D = new Map()), this.fnMaps.set(Q, D)), D.set(I, w));
      }
      errorToHandle(I) {
        return I instanceof G.Lifetime ? I : this.newError(I);
      }
    }
    return ((UA.QuickJSContext = N), UA);
  }
  var sI;
  function dI() {
    if (sI) return kA;
    ...
    class N {
        ...
        ((this.scope = new k.Scope()),
          ...
          (this.cToHostCallbacks = {
            shouldInterrupt: (Q) => {
              ...
              const D = this.interruptHandler;
              if (!D)
                throw new Error("QuickJSContext had no interrupt handler");
              return D(this) ? 1 : 0;
            },
            loadModuleSource: (0, C.maybeAsyncFn)(this, function* (Q, D, s, g) {
              const B = this.moduleLoader;
              if (!B) throw new Error("Runtime has no module loader");
              if (D !== this.rt.value)
                throw new Error("Runtime pointer mismatch");
              const o =
                this.contextMap.get(s) ??
                this.newContext({ contextPointer: s });
              try {
                const R = yield* Q(B(g, o));
                if (typeof R == "object" && "error" in R && R.error)
                  throw (
                    (0, h.debugLog)(
                ...
                const J = typeof R == "string" ? R : "value" in R ? R.value : R;
                return this.memory.newHeapCharPointer(J).value;
              } catch (R) {
                return (
                  (0, h.debugLog)("cToHostLoadModule: caught error", R),
                  o.throw(R),
                  0
                );
              }
            }),
            normalizeModule: (0, C.maybeAsyncFn)(
              this,
              function* (Q, D, s, g, B) {
                const o = this.moduleNormalizer;
                ...
                const R =
                  ...
                  this.newContext({ contextPointer: s });
                try {
                  const J = yield* Q(o(g, B, R));
                  if (typeof J == "object" && "error" in J && J.error)
                    throw (
                      (0, h.debugLog)(
                  ...
                  const H = typeof J == "string" ? J : J.value;
                  return R.getMemory(this.rt.value).newHeapCharPointer(H).value;
                } catch (J) {
                  return (
                    (0, h.debugLog)("normalizeModule: caught error", J),
                    R.throw(J),
                    0
                  );
                }
          ...
          (w = I.ownedLifetimes) == null ||
            w.forEach((Q) => this.scope.manage(Q)),
          (this.module = I.module),
          (this.memory = new A.ModuleMemory(this.module)),
          (this.ffi = I.ffi),
          (this.rt = I.rt),
      ...
      newContext(I = {}) {
        if (I.intrinsics && I.intrinsics !== c.DefaultIntrinsics)
          throw new Error("TODO: Custom intrinsics are not supported yet");
        const w = new k.Lifetime(
            I.contextPointer || this.ffi.QTS_NewContext(this.rt.value),
            void 0,
            (D) => {
              (this.contextMap.delete(D),
                this.callbacks.deleteContext(D),
                this.ffi.QTS_FreeContext(D));
            },
          ),
          Q = new U.QuickJSContext({
            module: this.module,
            ctx: w,
            ffi: this.ffi,
            rt: this.rt,
        ...
        return (this.contextMap.set(w.value, Q), Q);
      }
      setModuleLoader(I, w) {
        ((this.moduleLoader = I),
          (this.moduleNormalizer = w),
      ...
      setInterruptHandler(I) {
        const w = this.interruptHandler;
        ((this.interruptHandler = I),
          w || this.ffi.QTS_RuntimeEnableInterruptHandler(this.rt.value));
      }
      ...
      executePendingJobs(I = -1) {
        const w = this.memory.newMutablePointerArray(1),
          Q = this.ffi.QTS_ExecutePendingJob(
            this.rt.value,
            I ?? -1,
            w.value.ptr,
          ),
          D = w.value.typedArray[0];
        if ((w.dispose(), D === 0))
          return (
            this.ffi.QTS_FreeValuePointerRuntime(this.rt.value, Q),
            { value: 0 }
          );
        const s =
            this.contextMap.get(D) ?? this.newContext({ contextPointer: D }),
          g = s.getMemory(this.rt.value).heapValueHandle(Q);
        if (s.typeof(g) === "number") {
          const o = s.getNumber(g);
          return (g.dispose(), { value: o });
        } else return { error: Object.assign(g, { context: s }) };
      }
      setMemoryLimit(I) {
        if (I < 0 && I !== -1)
          throw new Error(
      ...
      computeMemoryUsage() {
        const I = this.getSystemContext().getMemory(this.rt.value);
      ...
      assertOwned(I) {
        if (I.owner && I.owner.rt !== this.rt)
          throw new G.QuickJSWrongOwner(
            `Handle is not owned by this runtime: ${I.owner.rt.value} != ${this.rt.value}`,
          );
      }
      getSystemContext() {
        return (
          this.context || (this.context = this.scope.manage(this.newContext())),
          this.context
        );
      }
    }
    return ((kA.QuickJSRuntime = N), kA);
  }
  var RI;
  function fI() {
    if (RI) return j;
    ((RI = 1),
      ...
      (j.QuickJSWASMModule =
        j.applyModuleEvalRuntimeOptions =
        j.applyBaseRuntimeOptions =
        j.QuickJSModuleCallbacks =
          void 0));
    const C = LA(),
      U = yA(),
      h = MA(),
    ...
    class A {
      constructor(Q) {
        ((this.callFunction = Q.callFunction),
          (this.shouldInterrupt = Q.shouldInterrupt),
          (this.loadModuleSource = Q.loadModuleSource),
          (this.normalizeModule = Q.normalizeModule));
      }
    }
    class c {
      constructor(Q) {
        ((this.contextCallbacks = new Map()),
          ...
          (this.cToHostCallbacks = new A({
            callFunction: (D, s, g, B, o, R) =>
              this.handleAsyncify(D, () => {
                try {
                  const J = this.contextCallbacks.get(s);
                  if (!J)
                    throw new Error(
                      `QuickJSContext(ctx = ${s}) not found for C function call "${R}"`,
                    );
                  return J.callFunction(s, g, B, o, R);
                } catch (J) {
                  return (
                    console.error("[C to host error: returning null]", J),
                    0
                  );
                }
              }),
            shouldInterrupt: (D, s) =>
              this.handleAsyncify(D, () => {
                try {
                  const g = this.runtimeCallbacks.get(s);
                  if (!g)
                    throw new Error(
                      `QuickJSRuntime(rt = ${s}) not found for C interrupt`,
                    );
                  return g.shouldInterrupt(s);
                } catch (g) {
                  return (
                    console.error("[C to host interrupt: returning error]", g),
                    1
                  );
                }
              }),
            loadModuleSource: (D, s, g, B) =>
              this.handleAsyncify(D, () => {
                try {
                  const o = this.runtimeCallbacks.get(s);
                  if (!o)
                    throw new Error(
                      `QuickJSRuntime(rt = ${s}) not found for C module loader`,
                    );
                  const R = o.loadModuleSource;
                  if (!R)
                    throw new Error(
                      `QuickJSRuntime(rt = ${s}) does not support module loading`,
                    );
                  return R(s, g, B);
                } catch (o) {
                  return (
            ...
            normalizeModule: (D, s, g, B, o) =>
              this.handleAsyncify(D, () => {
                try {
                  const R = this.runtimeCallbacks.get(s);
                  if (!R)
                    throw new Error(
                      `QuickJSRuntime(rt = ${s}) not found for C module loader`,
                    );
                  const J = R.normalizeModule;
                  if (!J)
                    throw new Error(
                      `QuickJSRuntime(rt = ${s}) does not support module loading`,
                    );
      ...
      setRuntimeCallbacks(Q, D) {
        this.runtimeCallbacks.set(Q, D);
      }
      deleteRuntime(Q) {
        this.runtimeCallbacks.delete(Q);
      }
      setContextCallbacks(Q, D) {
        this.contextCallbacks.set(Q, D);
      }
      deleteContext(Q) {
        this.contextCallbacks.delete(Q);
      }
      handleAsyncify(Q, D) {
        if (Q)
          return Q.handleSleep((g) => {
            try {
              const B = D();
              if (!(B instanceof Promise)) {
                ((0, C.debugLog)("asyncify.handleSleep: not suspending:", B),
                  g(B));
                return;
              }
              if (this.suspended)
                throw new U.QuickJSAsyncifyError(`Already suspended at: ${this.suspended.stack}
Attempted to suspend at:`);
              ((this.suspended = new U.QuickJSAsyncifySuspended(
                `(${this.suspendedCount++})`,
              )),
                (0, C.debugLog)(
                ...
                B.then(
                  (o) => {
                    ((this.suspended = void 0),
                      (0, C.debugLog)("asyncify.handleSleep: resolved:", o),
                      g(o));
                  },
                  (o) => {
                    ((0, C.debugLog)("asyncify.handleSleep: rejected:", o),
                      console.error(
              ...
              throw (
                (0, C.debugLog)("asyncify.handleSleep: error:", B),
                (this.suspended = void 0),
                B
              );
            }
    ...
    j.QuickJSModuleCallbacks = c;
    function N(w, Q) {
      (Q.interruptHandler && w.setInterruptHandler(Q.interruptHandler),
        Q.maxStackSizeBytes !== void 0 &&
          w.setMaxStackSize(Q.maxStackSizeBytes),
        Q.memoryLimitBytes !== void 0 && w.setMemoryLimit(Q.memoryLimitBytes));
    }
    j.applyBaseRuntimeOptions = N;
    function a(w, Q) {
      (Q.moduleLoader && w.setModuleLoader(Q.moduleLoader),
        Q.shouldInterrupt && w.setInterruptHandler(Q.shouldInterrupt),
        Q.memoryLimitBytes !== void 0 && w.setMemoryLimit(Q.memoryLimitBytes),
        Q.maxStackSizeBytes !== void 0 &&
          w.setMaxStackSize(Q.maxStackSizeBytes));
    }
    j.applyModuleEvalRuntimeOptions = a;
    class I {
      constructor(Q, D) {
        ((this.module = Q), (this.ffi = D), (this.callbacks = new c(Q)));
      }
      newRuntime(Q = {}) {
        const D = new h.Lifetime(this.ffi.QTS_NewRuntime(), void 0, (g) => {
            (this.callbacks.deleteRuntime(g), this.ffi.QTS_FreeRuntime(g));
          }),
          s = new G.QuickJSRuntime({
            module: this.module,
            callbacks: this.callbacks,
            ffi: this.ffi,
            rt: D,
        ...
        return (
          N(s, Q),
          Q.moduleLoader && s.setModuleLoader(Q.moduleLoader),
          s
        );
      }
      newContext(Q = {}) {
        const D = this.newRuntime(),
          s = D.newContext({
            ...Q,
            ownedLifetimes: (0, k.concat)(D, Q.ownedLifetimes),
          });
        return ((D.context = s), s);
      }
      evalCode(Q, D = {}) {
        return h.Scope.withScope((s) => {
          const g = s.manage(this.newContext());
          a(g.runtime, D);
          const B = g.evalCode(Q, "eval.js");
          if (
            (D.memoryLimitBytes !== void 0 && g.runtime.setMemoryLimit(-1),
            B.error)
          )
            throw g.dump(s.manage(B.error));
          return g.dump(s.manage(B.value));
        });
      }
      getFFI() {
        return this.ffi;
    ...
    return ((j.QuickJSWASMModule = I), j);
  }
  var tA = {},
    SA = {},
    JA = {},
  ...
  function ig() {
    ...
    ((GI = 1),
      ...
      (JA.QuickJSAsyncContext = void 0));
    const C = lI(),
      U = LA(),
      h = HA();
    class G extends C.QuickJSContext {
      async evalCodeAsync(A, c = "eval.js", N) {
        const a = N === void 0 ? 1 : 0,
          I = (0, h.evalOptionsToFlags)(N);
        let w = 0;
        try {
          w = await this.memory
            .newHeapCharPointer(A)
            .consume((D) =>
              this.ffi.QTS_Eval_MaybeAsync(this.ctx.value, D.value, c, a, I),
            );
        } catch (D) {
          throw ((0, U.debugLog)("QTS_Eval_MaybeAsync threw", D), D);
        }
        const Q = this.ffi.QTS_ResolveException(this.ctx.value, w);
        return Q
          ? (this.ffi.QTS_FreeValuePointer(this.ctx.value, w),
            { error: this.memory.heapValueHandle(Q) })
          : { value: this.memory.heapValueHandle(w) };
      }
      newAsyncifiedFunction(A, c) {
        return this.newFunction(A, c);
      }
    }
    return ((JA.QuickJSAsyncContext = G), JA);
  }
  var yI;
  function wg() {
    if (yI) return SA;
    ((yI = 1),
      Object.defineProperty(SA, "__esModule", { value: !0 }),
      (SA.QuickJSAsyncRuntime = void 0));
    const C = uI(),
      U = ig(),
      h = dI(),
      G = HA();
    class k extends h.QuickJSRuntime {
      constructor(c) {
        super(c);
      }
      newContext(c = {}) {
        if (c.intrinsics && c.intrinsics !== G.DefaultIntrinsics)
          throw new Error("TODO: Custom intrinsics are not supported yet");
        const N = new C.Lifetime(
            this.ffi.QTS_NewContext(this.rt.value),
            void 0,
            (I) => {
              (this.contextMap.delete(I),
                this.callbacks.deleteContext(I),
                this.ffi.QTS_FreeContext(I));
            },
          ),
          a = new U.QuickJSAsyncContext({
            module: this.module,
            ctx: N,
            ffi: this.ffi,
            rt: this.rt,
        ...
        return (this.contextMap.set(N.value, a), a);
      }
      setModuleLoader(c, N) {
        super.setModuleLoader(c, N);
      }
      setMaxStackSize(c) {
        return super.setMaxStackSize(c);
      }
    }
    return ((SA.QuickJSAsyncRuntime = k), SA);
  }
  var MI;
  function og() {
    if (MI) return tA;
    ((MI = 1),
      ...
      (tA.QuickJSAsyncWASMModule = void 0));
    const C = yA(),
      U = MA(),
      h = fI(),
      G = wg();
    class k extends h.QuickJSWASMModule {
      constructor(c, N) {
        (super(c, N), (this.ffi = N), (this.module = c));
      }
      newRuntime(c = {}) {
        const N = new U.Lifetime(this.ffi.QTS_NewRuntime(), void 0, (I) => {
            (this.callbacks.deleteRuntime(I), this.ffi.QTS_FreeRuntime(I));
          }),
          a = new G.QuickJSAsyncRuntime({
            module: this.module,
            ffi: this.ffi,
            rt: N,
            callbacks: this.callbacks,
        ...
        return (
          (0, h.applyBaseRuntimeOptions)(a, c),
          c.moduleLoader && a.setModuleLoader(c.moduleLoader),
          a
        );
      }
      newContext(c = {}) {
        const N = this.newRuntime(),
          a = c.ownedLifetimes ? c.ownedLifetimes.concat([N]) : [N],
          I = N.newContext({ ...c, ownedLifetimes: a });
        return ((N.context = I), I);
      }
      evalCode() {
        throw new C.QuickJSNotImplemented(
          "QuickJSWASMModuleAsyncify.evalCode: use evalCodeAsync instead",
        );
      }
      evalCodeAsync(c, N) {
        return U.Scope.withScopeAsync(async (a) => {
          const I = a.manage(this.newContext());
          (0, h.applyModuleEvalRuntimeOptions)(I.runtime, N);
          const w = await I.evalCodeAsync(c, "eval.js");
          if (
            (N.memoryLimitBytes !== void 0 && I.runtime.setMemoryLimit(-1),
            w.error)
          )
            throw I.dump(a.manage(w.error));
          return I.dump(a.manage(w.value));
        });
      }
    }
    return ((tA.QuickJSAsyncWASMModule = k), tA);
  }
  var KA = {},
    hI;
  function Fg() {
    ...
    return ((KA.QuickJSFFI = C), KA);
  }
  var WA = { exports: {} };
  const sg = {},
    Rg = Object.freeze(
      Object.defineProperty(
        { __proto__: null, default: sg },
        Symbol.toStringTag,
        { value: "Module" },
      ),
    ),
      ...
      kI ||
        ...
        (function (C) {
          ...
          ((C.format = function (i) {
            ...
            for (
              var S = 1,
                n = arguments,
                f = n.length,
                r = String(i).replace(h, function (d) {
                  if (d === "%%") return "%";
                  if (S >= f) return d;
                  switch (d) {
                    case "%s":
            ...
            (C.deprecate = function (i, M) {
              if (q(VI.process))
                return function () {
                  return C.deprecate(i, M).apply(this, arguments);
                };
              if (process.noDeprecation === !0) return i;
              var S = !1;
              function n() {
                if (!S) {
                  if (process.throwDeprecation) throw new Error(M);
          ...
          C.debuglog = function (i) {
            if (
              (q(k) && (k = U.NODE_DEBUG || ""), (i = i.toUpperCase()), !G[i])
            )
              if (new RegExp("\\b" + i + "\\b", "i").test(k)) {
                var M = process.pid;
                G[i] = function () {
                  var S = C.format.apply(C, arguments);
                  console.error("%s %d: %s", i, M, S);
                };
              } else G[i] = function () {};
            return G[i];
          };
          function A(i, M) {
            ...
            return (
              ...
              o(M) ? (S.showHidden = M) : M && C._extend(S, M),
              q(S.showHidden) && (S.showHidden = !1),
              q(S.depth) && (S.depth = 2),
              q(S.colors) && (S.colors = !1),
              q(S.customInspect) && (S.customInspect = !0),
          ...
          function I(i, M, S) {
            ...
            var r = Object.keys(M),
              l = a(r);
            if (
              (i.showHidden && (r = Object.getOwnPropertyNames(M)),
              W(M) &&
            ...
            if (r.length === 0) {
              if (V(M)) {
                var d = M.name ? ": " + M.name : "";
                return i.stylize("[Function" + d + "]", "special");
              }
              if (Z(M))
                return i.stylize(RegExp.prototype.toString.call(M), "regexp");
              if (v(M))
                return i.stylize(Date.prototype.toString.call(M), "date");
              if (W(M)) return Q(M);
            }
            var b = "",
              z = !1,
              FA = ["{", "}"];
            if ((B(M) && ((z = !0), (FA = ["[", "]"])), V(M))) {
              var YA = M.name ? ": " + M.name : "";
              b = " [Function" + YA + "]";
            }
            if (
              (Z(M) && (b = " " + RegExp.prototype.toString.call(M)),
              v(M) && (b = " " + Date.prototype.toUTCString.call(M)),
              W(M) && (b = " " + Q(M)),
              r.length === 0 && (!z || M.length == 0))
            )
              return FA[0] + b + FA[1];
            if (S < 0)
              return Z(M)
                ? i.stylize(RegExp.prototype.toString.call(M), "regexp")
          ...
          function w(i, M) {
            if (q(M)) return i.stylize("undefined", "undefined");
            if (K(M)) {
              var S =
                "'" +
                JSON.stringify(M)
                  ...
                  .replace(/\\"/g, '"') +
                "'";
              return i.stylize(S, "string");
            }
            if (H(M)) return i.stylize("" + M, "number");
            if (o(M)) return i.stylize("" + M, "boolean");
            if (R(M)) return i.stylize("null", "null");
          }
          function Q(i) {
            return "[" + Error.prototype.toString.call(i) + "]";
          }
          function D(i, M, S, n, f) {
            for (var r = [], l = 0, d = M.length; l < d; ++l)
              Y(M, String(l))
                ? r.push(s(i, M, S, n, String(l), !0))
                : r.push("");
            return (
              f.forEach(function (b) {
                b.match(/^\d+$/) || r.push(s(i, M, S, n, b, !0));
              }),
              r
            );
          }
          function s(i, M, S, n, f, r) {
            var l, d, b;
            if (
              ((b = Object.getOwnPropertyDescriptor(M, f) || { value: M[f] }),
              b.get
                ? b.set
                  ? (d = i.stylize("[Getter/Setter]", "special"))
                  : (d = i.stylize("[Getter]", "special"))
                : b.set && (d = i.stylize("[Setter]", "special")),
              Y(n, f) || (l = "[" + f + "]"),
              d ||
                (i.seen.indexOf(b.value) < 0
                  ? (R(S)
                      ? (d = I(i, b.value, null))
                      : (d = I(i, b.value, S - 1)),
                    d.indexOf(`
...
`))))
                  : (d = i.stylize("[Circular]", "special"))),
              q(l))
            ) {
              if (r && f.match(/^\d+$/)) return d;
              ((l = JSON.stringify("" + f)),
                l.match(/^"([a-zA-Z_][a-zA-Z_0-9]*)"$/)
                  ...
                  : ((l = l
                      ...
                      .replace(/\\"/g, '"')
                      .replace(/(^"|"$)/g, "'")),
                    (l = i.stylize(l, "string"))));
            }
            return l + ": " + d;
          }
          function g(i, M, S) {
            var n = i.reduce(function (f, r) {
              return (
                r.indexOf(`
`) >= 0,
                f + r.replace(/\u001b\[\d\d?m/g, "").length + 1
              );
            }, 0);
            return n > 60
              ? S[0] +
 ...
 `) +
  ...
  `) +
          ...
          C.isObject = P;
          function v(i) {
            return P(i) && T(i) === "[object Date]";
          }
          C.isDate = v;
          function W(i) {
            return P(i) && (T(i) === "[object Error]" || i instanceof Error);
          }
          C.isError = W;
          function V(i) {
          ...
          ((C.isPrimitive = oA), (C.isBuffer = yg()));
          function T(i) {
          ...
          function t() {
            ...
            return [i.getDate(), AA[i.getMonth()], M].join(" ");
          }
          ((C.log = function () {
            console.log("%s - %s", t(), C.format.apply(C, arguments));
          }),
            (C.inherits = Mg()),
            (C._extend = function (i, M) {
              if (!M || !P(M)) return i;
              for (var S = Object.keys(M), n = S.length; n--; )
                i[S[n]] = M[S[n]];
              return i;
            }));
          function Y(i, M) {
  ...
  function cg() {
    ...
    function k(g) {
      for (var B = g.length - 1, o = 0; o <= B && !g[o]; o++);
      for (var R = B; R >= 0 && !g[R]; R--);
      return o === 0 && R === B ? g : o > R ? [] : g.slice(o, R + 1);
    }
    var A =
        /^([a-zA-Z]:|[\\\/]{2}[^\\\/]+[\\\/]+[^\\\/]+)?([\\\/])?([\s\S]*?)$/,
      c = /^([\s\S]*?)((?:\.{1,2}|[^\\\/]+?|)(\.[^.\/\\]*|))(?:[\\\/]*)$/,
    ...
    function I(g) {
      var B = A.exec(g),
        o = B[1] || "",
        R = !!o && o[1] !== ":";
      return { device: o, isUnc: R, isAbsolute: R || !!B[2], tail: B[3] };
    }
    function w(g) {
      return "\\\\" + g.replace(/^[\\\/]+/, "").replace(/[\\\/]+/g, "\\");
    }
    ((N.resolve = function () {
      for (var g = "", B = "", o = !1, R = arguments.length - 1; R >= -1; R--) {
        var J;
        if (
          (R >= 0
            ? (J = arguments[R])
            : g
              ? ((J = C["=" + g]),
                (!J ||
                  J.substr(0, 3).toLowerCase() !== g.toLowerCase() + "\\") &&
                  (J = g + "\\"))
              : (J = process.cwd()),
          h.isString(J))
        ) {
        ...
        var H = I(J),
          ...
          Z = H.tail;
        if (
          !(K && g && K.toLowerCase() !== g.toLowerCase()) &&
          (g || (g = K), o || ((B = Z + "\\" + B), (o = q)), g && o)
        )
          break;
      }
      return (
      ...
      (N.isAbsolute = function (g) {
        return I(g).isAbsolute;
      }),
      (N.join = function () {
      ...
      (N.relative = function (g, B) {
        ((g = N.resolve(g)), (B = N.resolve(B)));
        for (
          var o = g.toLowerCase(),
            R = B.toLowerCase(),
            J = k(B.split("\\")),
        ...
        if (q == 0) return B;
        for (var P = [], Z = q; Z < H.length; Z++) P.push("..");
        return ((P = P.concat(J.slice(q))), P.join("\\"));
      }),
      (N._makeLong = function (g) {
        if (!h.isString(g)) return g;
        if (!g) return "";
        var B = N.resolve(g);
      ...
      (N.dirname = function (g) {
        var B = a(g),
          o = B[0],
          R = B[1];
        return !o && !R ? "." : (R && (R = R.substr(0, R.length - 1)), o + R);
      }),
      (N.basename = function (g, B) {
        var o = a(g)[2];
        return (
          B &&
            o.substr(-1 * B.length) === B &&
            (o = o.substr(0, o.length - B.length)),
          o
        );
      }),
      (N.extname = function (g) {
        return a(g)[3];
      }),
      (N.format = function (g) {
        if (!h.isObject(g))
        ...
        var o = g.dir,
          R = g.base || "";
        return o ? (o[o.length - 1] === N.sep ? o + R : o + N.sep + R) : R;
      }),
      (N.parse = function (g) {
        if (!h.isString(g))
          throw new TypeError(
            "Parameter 'pathString' must be a string, not " + typeof g,
          );
        var B = a(g);
        if (!B || B.length !== 4)
          throw new TypeError("Invalid path '" + g + "'");
        return {
          root: B[0],
    ...
    var Q = /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/,
      D = {};
    function s(g) {
      return Q.exec(g).slice(1);
    }
    return (
      (D.resolve = function () {
        for (var g = "", B = !1, o = arguments.length - 1; o >= -1 && !B; o--) {
          var R = o >= 0 ? arguments[o] : process.cwd();
          if (h.isString(R)) {
            if (!R) continue;
          } else
        ...
        return ((g = G(g.split("/"), !B).join("/")), (B ? "/" : "") + g || ".");
      }),
      (D.normalize = function (g) {
        var B = D.isAbsolute(g),
          o = g && g[g.length - 1] === "/";
        return (
          (g = G(g.split("/"), !B).join("/")),
          !g && !B && (g = "."),
      ...
      (D.join = function () {
        ...
        return D.normalize(g);
      }),
      (D.relative = function (g, B) {
        ((g = D.resolve(g).substr(1)), (B = D.resolve(B).substr(1)));
        for (
          var o = k(g.split("/")),
            R = k(B.split("/")),
            J = Math.min(o.length, R.length),
            H = J,
            K = 0;
          K < J;
          K++
        ...
        for (var p = [], K = H; K < o.length; K++) p.push("..");
        return ((p = p.concat(R.slice(H))), p.join("/"));
      }),
      (D._makeLong = function (g) {
        return g;
      }),
          ...
          var h = (() => {
            var G =
              typeof document < "u" && document.currentScript
                ...
                : void 0;
            return (
              typeof __filename < "u" && (G = G || __filename),
              function (k = {}) {
                var A;
                A || (A = typeof k < "u" ? k : {});
                var c, N;
                A.ready = new Promise(function (E, F) {
                  ((c = E), (N = F));
                });
                    ...
                    (g = (E, F) => {
                      ...
                      return y
                        ...
                        : ((E = E.startsWith("file://")
                            ? new URL(E)
                            : J.normalize(E)),
                          R.readFileSync(E, F ? void 0 : "utf8"));
                    }),
                    (o = (E) => (
                      (E = g(E, !0)),
                ...
                var H = A.print || console.log.bind(console),
                  K = A.printErr || console.warn.bind(console);
                (Object.assign(A, a),
                  (a = null),
                  A.thisProgram && (I = A.thisProgram));
                var p;
                (A.wasmBinary && (p = A.wasmBinary),
                  A.noExitRuntime,
                ...
                function oA() {
                  var E = q.buffer;
                  ((A.HEAP8 = P = new Int8Array(E)),
                    (A.HEAP16 = new Int16Array(E)),
                    (A.HEAP32 = W = new Int32Array(E)),
                    (A.HEAPU8 = v = new Uint8Array(E)),
                ...
                if (
                  ...
                  var f = n;
                  n = A.locateFile ? A.locateFile(f, s) : s + f;
                }
                function r(E) {
                  try {
                    if (E == n && p) return new Uint8Array(p);
                    var F = hA(E);
                    if (F) return F;
                    if (o) return o(E);
                ...
                function b(E, F) {
                  ...
                  return p ||
                    ...
                    ? d(y, E, F)
                    : fetch(y, { credentials: "same-origin" }).then(
                        function (e) {
                          return WebAssembly.instantiateStreaming(e, E).then(
                            F,
                            function (L) {
                              return (
                ...
                function YA(E, F, y) {
                  var e = F + y;
                  for (y = F; E[y] && !(y >= e); ) ++y;
                  if (16 < y - F && E.buffer && FA)
                    return FA.decode(E.subarray(F, y));
                  for (e = ""; F < y; ) {
                    var L = E[F++];
                    if (L & 128) {
                      var u = E[F++] & 63;
                      if ((L & 224) == 192)
                        e += String.fromCharCode(((L & 31) << 6) | u);
                      else {
                        var m = E[F++] & 63;
                        ((L =
                          (L & 240) == 224
                ...
                var uA = [
                  ...
                  pI = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334];
                function pA(E) {
                  for (var F = 0, y = 0; y < E.length; ++y) {
                    var e = E.charCodeAt(y);
                    127 >= e
                      ? F++
                      : 2047 >= e
                        ? (F += 2)
                ...
                function mA(E, F, y) {
                  ...
                  for (var u = 0; u < E.length; ++u) {
                    ...
                    if (55296 <= m && 57343 >= m) {
                      var x = E.charCodeAt(++u);
                      m = (65536 + ((m & 1023) << 10)) | (x & 1023);
                    }
                    if (127 >= m) {
                      if (F >= y) break;
                      e[F++] = m;
                ...
                function vA() {
                  if (!qA) {
                    var E = {
                      ...
                      F;
                    for (F in bA)
                      bA[F] === void 0 ? delete E[F] : (E[F] = bA[F]);
                    var y = [];
                    for (F in E) y.push(F + "=" + E[F]);
                    qA = y;
                  }
                  return qA;
                }
                    ...
                    : function (E) {
                        ...
                        do {
                          ...
                          ((F += String.fromCharCode(e)),
                            u !== 64 && (F += String.fromCharCode(L)),
                            m !== 64 && (F += String.fromCharCode(x)));
                        } while (y < E.length);
                        return F;
                      };
                function hA(E) {
                  if (E.startsWith(S)) {
                    if (((E = E.slice(S.length)), typeof D == "boolean" && D)) {
                      var F = Buffer.from(E, "base64");
                      F = new Uint8Array(F.buffer, F.byteOffset, F.byteLength);
                    } else
                      try {
                        var y = qI(E),
                          e = new Uint8Array(y.length);
                        for (E = 0; E < y.length; ++E) e[E] = y.charCodeAt(E);
                        F = e;
                      } catch {
                        throw Error(
                ...
                var xI = {
                  a: function (E, F, y, e) {
                    M(
                      "Assertion failed: " +
                        ...
                        ", at: " +
                        [
                          F ? _(F) : "unknown filename",
                          y,
                          e ? _(e) : "unknown function",
                        ],
                    );
                  },
                  l: function (E, F) {
                    ((E = new Date(
                      1e3 * (V[E >> 2] + 4294967296 * W[(E + 4) >> 2]),
                    )),
                      (W[F >> 2] = E.getSeconds()),
                      (W[(F + 4) >> 2] = E.getMinutes()),
                      (W[(F + 8) >> 2] = E.getHours()),
                      (W[(F + 12) >> 2] = E.getDate()),
                      (W[(F + 16) >> 2] = E.getMonth()),
                      (W[(F + 20) >> 2] = E.getFullYear() - 1900),
                      (W[(F + 24) >> 2] = E.getDay()));
                    var y = E.getFullYear();
                    ((W[(F + 28) >> 2] =
                      ((y % 4 !== 0 || (y % 100 === 0 && y % 400 !== 0)
                        ...
                        1) |
                      0),
                      (W[(F + 36) >> 2] = -(60 * E.getTimezoneOffset())),
                      (y = new Date(
                        E.getFullYear(),
                        6,
                        1,
                      ).getTimezoneOffset()));
                    var e = new Date(E.getFullYear(), 0, 1).getTimezoneOffset();
                    W[(F + 32) >> 2] =
                      (y != e && E.getTimezoneOffset() == Math.min(e, y)) | 0;
                  },
                  k: function (E, F, y) {
                    function e(IA) {
                      return (IA = IA.toTimeString().match(/\(([A-Za-z ]+)\)$/))
                        ? IA[1]
                        : "GMT";
                    }
                    ...
                    var x = m.getTimezoneOffset();
                    ((V[E >> 2] = 60 * Math.max(L, x)),
                      (W[F >> 2] = +(L != x)),
                      (E = e(u)),
                      (F = e(m)),
                      (E = TA(E)),
                    ...
                    return (
                      vA().forEach(function (e, L) {
                        ...
                        for (
                          ...
                          P[L++ >> 0] = e.charCodeAt(u);
                        ((P[L >> 0] = 0), (y += e.length + 1));
                      }),
                      0
                    );
                  },
                  ...
                  o: function (E, F, y, e, L) {
                    return A.callbacks.callFunction(void 0, E, F, y, e, L);
                  },
                  n: function (E) {
                    return A.callbacks.shouldInterrupt(void 0, E);
                  },
                  h: function (E, F, y) {
                    return (
                      (y = _(y)),
                      A.callbacks.loadModuleSource(void 0, E, F, y)
                    );
                  },
                  g: function (E, F, y, e) {
                    return (
                      (y = _(y)),
                      (e = _(e)),
                      A.callbacks.normalizeModule(void 0, E, F, y, e)
                    );
                  },
                };
                (function () {
                ...
                var jA = (A._malloc = function () {
                  return (jA = A._malloc = A.asm.r).apply(null, arguments);
                });
                ((A._QTS_Throw = function () {
                  ...
                  (A._QTS_RuntimeSetMemoryLimit = function () {
                    return (A._QTS_RuntimeSetMemoryLimit = A.asm.u).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_RuntimeComputeMemoryUsage = function () {
                    return (A._QTS_RuntimeComputeMemoryUsage = A.asm.v).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_RuntimeDumpMemoryUsage = function () {
                    return (A._QTS_RuntimeDumpMemoryUsage = A.asm.w).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_RecoverableLeakCheck = function () {
                    return (A._QTS_RecoverableLeakCheck = A.asm.x).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_BuildIsSanitizeLeak = function () {
                    return (A._QTS_BuildIsSanitizeLeak = A.asm.y).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_RuntimeSetMaxStackSize = function () {
                    return (A._QTS_RuntimeSetMaxStackSize = A.asm.z).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_GetUndefined = function () {
                    return (A._QTS_GetUndefined = A.asm.A).apply(
                      null,
                      arguments,
                    );
                  }),
                  ...
                  (A._QTS_FreeRuntime = function () {
                    return (A._QTS_FreeRuntime = A.asm.F).apply(
                      null,
                      arguments,
                    );
                  }),
                  ...
                  (A._QTS_FreeContext = function () {
                    return (A._QTS_FreeContext = A.asm.H).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_FreeValuePointer = function () {
                    return (A._QTS_FreeValuePointer = A.asm.I).apply(
                      null,
                      arguments,
                    );
                  }),
                  ...
                  (A._QTS_FreeValuePointerRuntime = function () {
                    return (A._QTS_FreeValuePointerRuntime = A.asm.K).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_FreeVoidPointer = function () {
                    return (A._QTS_FreeVoidPointer = A.asm.L).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_FreeCString = function () {
                    return (A._QTS_FreeCString = A.asm.M).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_DupValuePointer = function () {
                    return (A._QTS_DupValuePointer = A.asm.N).apply(
                      null,
                      arguments,
                    );
                  }),
                  ...
                  (A._QTS_NewObjectProto = function () {
                    return (A._QTS_NewObjectProto = A.asm.P).apply(
                      null,
                      arguments,
                    );
                  }),
                  ...
                  (A._QTS_GetSymbolDescriptionOrKey = function () {
                    return (A._QTS_GetSymbolDescriptionOrKey = A.asm.W).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_IsGlobalSymbol = function () {
                    return (A._QTS_IsGlobalSymbol = A.asm.X).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_IsJobPending = function () {
                    return (A._QTS_IsJobPending = A.asm.Y).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_ExecutePendingJob = function () {
                    return (A._QTS_ExecutePendingJob = A.asm.Z).apply(
                      null,
                      arguments,
                    );
                  }),
                  ...
                  (A._QTS_DefineProp = function () {
                    return (A._QTS_DefineProp = A.asm.aa).apply(
                      null,
                      arguments,
                    );
                  }),
                  ...
                  (A._QTS_ResolveException = function () {
                    return (A._QTS_ResolveException = A.asm.ca).apply(
                      null,
                      arguments,
                    );
                  }),
                  ...
                  (A._QTS_GetGlobalObject = function () {
                    return (A._QTS_GetGlobalObject = A.asm.ga).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_NewPromiseCapability = function () {
                    return (A._QTS_NewPromiseCapability = A.asm.ha).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_TestStringArg = function () {
                    return (A._QTS_TestStringArg = A.asm.ia).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_BuildIsDebug = function () {
                    return (A._QTS_BuildIsDebug = A.asm.ja).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_BuildIsAsyncify = function () {
                    return (A._QTS_BuildIsAsyncify = A.asm.ka).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_NewFunction = function () {
                    return (A._QTS_NewFunction = A.asm.la).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_ArgvGetJSValueConstPointer = function () {
                    return (A._QTS_ArgvGetJSValueConstPointer = A.asm.ma).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_RuntimeEnableInterruptHandler = function () {
                    return (A._QTS_RuntimeEnableInterruptHandler =
                      A.asm.na).apply(null, arguments);
                  }),
                  (A._QTS_RuntimeDisableInterruptHandler = function () {
                    return (A._QTS_RuntimeDisableInterruptHandler =
                      A.asm.oa).apply(null, arguments);
                  }),
                  (A._QTS_RuntimeEnableModuleLoader = function () {
                    return (A._QTS_RuntimeEnableModuleLoader = A.asm.pa).apply(
                      null,
                      arguments,
                    );
                  }),
                  (A._QTS_RuntimeDisableModuleLoader = function () {
                    return (A._QTS_RuntimeDisableModuleLoader = A.asm.qa).apply(
                      null,
                      arguments,
                    );
                  }));
                function zA() {
                  return (zA = A.asm.sa).apply(null, arguments);
                }
                function _A() {
                  return (_A = A.asm.ta).apply(null, arguments);
                }
                function xA() {
                  return (xA = A.asm.ua).apply(null, arguments);
                }
                ((A.___start_em_js = 74916),
                  (A.___stop_em_js = 75818),
                  (A.cwrap = function (E, F, y, e) {
                    var L =
                      !y || y.every((u) => u === "number" || u === "boolean");
                    return F !== "string" && L && !e
                      ? A["_" + E]
                      : function () {
                          return bI(E, F, y, arguments);
                        };
                  }),
                  (A.UTF8ToString = _),
                  (A.stringToUTF8 = function (E, F, y) {
                    return mA(E, F, y);
                  }),
        ...
        (function (C) {
          var U =
              ...
              (Object.create
                ? function (a, I, w, Q) {
                    Q === void 0 && (Q = w);
                    var D = Object.getOwnPropertyDescriptor(I, w);
                    ((!D ||
                      ("get" in D
                        ? !I.__esModule
                      ...
                      Object.defineProperty(a, Q, D));
                  }
                : function (a, I, w, Q) {
                    (Q === void 0 && (Q = w), (a[Q] = I[w]));
                  }),
            h =
          ...
          (Object.defineProperty(C, "__esModule", { value: !0 }),
            (C.RELEASE_ASYNC =
              ...
              C.RELEASE_SYNC =
              C.DEBUG_SYNC =
              C.memoizePromiseFactory =
              C.newQuickJSAsyncWASMModule =
              C.newQuickJSWASMModule =
                void 0));
          const k = Eg();
          async function A(a = C.RELEASE_SYNC) {
            const [I, w, { QuickJSWASMModule: Q }] = await Promise.all([
                a.importModuleLoader(),
                a.importFFI(),
                Promise.resolve()
                  .then(() => G(fI()))
                  .then(k.unwrapTypescript),
              ]),
              D = await I();
            D.type = "sync";
            const s = new w(D);
          ...
          C.newQuickJSWASMModule = A;
          async function c(a = C.RELEASE_ASYNC) {
            const [I, w, { QuickJSAsyncWASMModule: Q }] = await Promise.all([
                a.importModuleLoader(),
                a.importFFI(),
                Promise.resolve()
                  .then(() => G(og()))
          ...
          C.newQuickJSAsyncWASMModule = c;
          function N(a) {
            let I;
            return () => I ?? (I = a());
          }
          ((C.memoizePromiseFactory = N),
            (C.DEBUG_SYNC = {
              type: "sync",
              async importFFI() {
            ...
            (C.RELEASE_SYNC = {
              type: "sync",
              async importFFI() {
                const a = await Promise.resolve().then(() => G(Fg()));
                return (0, k.unwrapTypescript)(a).QuickJSFFI;
              },
              async importModuleLoader() {
                const a = await Promise.resolve().then(() => G(Ng()));
                return (0, k.unwrapJavascript)(a);
              },
            }),
            (C.DEBUG_ASYNC = {
              type: "async",
  ...
  function ag() {
    ...
    ((SI = 1),
      ...
      (nA.TestQuickJSWASMModule = void 0));
    const C = yA(),
      U = MA();
    class h {
      constructor(k) {
      ...
      newRuntime(k) {
        const A = this.parent.newRuntime({
          ...k,
          ownedLifetimes: [
            new U.Lifetime(void 0, void 0, () => this.runtimes.delete(A)),
            ...((k == null ? void 0 : k.ownedLifetimes) ?? []),
          ],
        });
        return (this.runtimes.add(A), A);
      }
      newContext(k) {
        const A = this.parent.newContext({
          ...k,
          ownedLifetimes: [
            new U.Lifetime(void 0, void 0, () => this.contexts.delete(A)),
            ...((k == null ? void 0 : k.ownedLifetimes) ?? []),
          ],
        });
        return (this.contexts.add(A), A);
      }
      evalCode(k, A) {
        return this.parent.evalCode(k, A);
      }
      disposeAll() {
        const k = [...this.contexts, ...this.runtimes];
        (this.runtimes.clear(),
          this.contexts.clear(),
          k.forEach((A) => {
            A.alive && A.dispose();
      ...
      assertNoMemoryAllocated() {
        if (this.getFFI().QTS_RecoverableLeakCheck())
          throw new C.QuickJSMemoryLeakDetected(
            "Leak sanitizer detected un-freed memory",
          );
        if (this.contexts.size > 0)
          throw new C.QuickJSMemoryLeakDetected(
            `${this.contexts.size} contexts leaked`,
          );
        if (this.runtimes.size > 0)
          throw new C.QuickJSMemoryLeakDetected(
            `${this.runtimes.size} runtimes leaked`,
          );
      }
      getFFI() {
    ...
    return ((nA.TestQuickJSWASMModule = h), nA);
  }
  var JI;
  function uI() {
    return (
        ...
        (function (C) {
          var U =
              ...
              (Object.create
                ? function (s, g, B, o) {
                    o === void 0 && (o = B);
                    var R = Object.getOwnPropertyDescriptor(g, B);
                    ((!R ||
                      ("get" in R
                        ? !g.__esModule
          ...
          (Object.defineProperty(C, "__esModule", { value: !0 }),
            (C.shouldInterruptAfterDeadline =
              C.newAsyncContext =
              C.newAsyncRuntime =
              C.getQuickJSSync =
              C.getQuickJS =
              ...
              C.newQuickJSWASMModule =
                void 0));
          const A = kg();
          (Object.defineProperty(C, "newQuickJSWASMModule", {
            enumerable: !0,
            get: function () {
              return A.newQuickJSWASMModule;
            },
          }),
            Object.defineProperty(C, "newQuickJSAsyncWASMModule", {
              enumerable: !0,
              get: function () {
                return A.newQuickJSAsyncWASMModule;
              },
            }),
            Object.defineProperty(C, "DEBUG_ASYNC", {
              enumerable: !0,
              get: function () {
                return A.DEBUG_ASYNC;
              },
            }),
            Object.defineProperty(C, "DEBUG_SYNC", {
              enumerable: !0,
              get: function () {
                return A.DEBUG_SYNC;
              },
            }),
            Object.defineProperty(C, "RELEASE_ASYNC", {
              enumerable: !0,
              get: function () {
                return A.RELEASE_ASYNC;
              },
            }),
            Object.defineProperty(C, "RELEASE_SYNC", {
              enumerable: !0,
              get: function () {
                return A.RELEASE_SYNC;
              },
            }),
            G(Ug(), C),
            G(MA(), C),
          ...
          async function a() {
            return (
              N ??
                (N = (0, A.newQuickJSWASMModule)().then((s) => ((c = s), s))),
              await N
            );
          }
          C.getQuickJS = a;
          function I() {
            if (!c)
              throw new Error(
                "QuickJS not initialized. Await getQuickJS() at least once.",
              );
            return c;
          }
          C.getQuickJSSync = I;
          async function w(s) {
            return (await (0, A.newQuickJSAsyncWASMModule)()).newRuntime(s);
          }
          C.newAsyncRuntime = w;
          async function Q(s) {
            return (await (0, A.newQuickJSAsyncWASMModule)()).newContext(s);
          }
          C.newAsyncContext = Q;
          function D(s) {
            const g = typeof s == "number" ? s : s.getTime();
            return function () {
              return Date.now() > g;
            };
          }
          C.shouldInterruptAfterDeadline = D;
        })(gA)),
      gA
    );
  }
  var eg = uI();
  const tg = 32 * 1024 * 1024,
    Sg = 1024 * 1024;
  let XA = null;
  function Jg(C) {
    return C ? C() : (XA || (XA = eg.newQuickJSWASMModule()), XA);
  }
  function Kg(C) {
  ...
  function ng(C, U) {
    ...
    return C.unwrapResult(C.evalCode(`(${h})`));
  }
  function dA(C, U) {
    return C.newError(OA(U));
  }
  function KI(C, U, h) {
    const G = C.newFunction(U, h);
    (C.setProp(C.global, U, G), wA(G));
  }
  function nI(C) {
    for (; C.hasPendingJob(); ) {
      const U = C.executePendingJobs();
      if ("error" in U) {
        const h = U.error.context.dump(U.error);
        throw (wA(U.error), new Error(OA(h)));
      }
    }
  }
  async function Lg(C, U) {
    const h = { ...fA, ...U.limits },
      G = XI(),
      A = (await Jg(U.moduleLoader)).newRuntime(),
      c = A.newContext(),
      N = Date.now() + h.timeoutMs;
    let a = !0,
      I = null;
    (A.setMemoryLimit(tg),
      A.setMaxStackSize(Sg),
      A.setInterruptHandler(() => Date.now() > N));
    const w = (o, R) => {
        zI(G, o, R);
      },
      Q = (o) => {
        I || (I = o instanceof Error ? o : new Error(OA(o)));
      },
      D = () => {
        if (a)
          try {
    ...
    (KI(c, "__bpsConsoleLog", (o, R) => {
      ...
      KI(c, "__bpsHostCall", (o) => {
        ...
        if (!vI(R)) {
          ...
          return (J.reject(H), wA(H), D(), J.handle);
        }
        return (
          U.hostCall(R).then(
            (H) => {
    ...
    let g, B;
    try {
      ((g = c.unwrapResult(c.evalCode(s))), nI(A));
      const o = await c.resolvePromise(g);
      if (((B = c.unwrapResult(o)), I)) throw I;
      const R = c.dump(B);
      if (typeof R < "u" && !PI(R))
        throw new Error(
          "run_officejs returned a non-serializable value. Return primitives, arrays, or plain objects.",
        );
      return { logs: G.entries, result: R };
    } catch (o) {
      throw new Error(OI(o, G.entries));
    } finally {
      ((a = !1), wA(B), wA(g), c.dispose(), A.dispose());
    }
  }
  function Hg(C = {}) {
    const U = C.windowRef ?? window,
      h = C.runProgram ?? Lg;
    let G = !1,
      k = null;
    const A = (c) => {
      if (G || c.source !== U.parent || !_I(c.data)) return;
      QA.info("[bps][officejs-sandbox] guest received bootstrap message", {
        invocationId: c.data.invocationId,
      });
      const [N] = c.ports;
      if (!N) {
        QA.error("[bps][officejs-sandbox] guest bootstrap missing MessagePort");
        return;
      }
      ((G = !0),
        (k = Yg(N, {
    ...
    return (
      ...
      QA.info("[bps][officejs-sandbox] guest bootstrap listener attached"),
      () => {
        (U.removeEventListener("message", A), k == null || k(), (k = null));
      }
    );
  }
  function Yg(C, U) {
    var D;
    const { invocationId: h, nonce: G, runProgram: k } = U,
      A = new Map();
    let c = !1,
      N = !1;
    const a = (s) =>
        new Promise((g, B) => {
          (QA.info("[bps][officejs-sandbox] guest sending sync request", {
            invocationId: h,
            requestId: s.requestId,
            commandCount: s.commands.length,
          }),
            A.set(s.requestId, { resolve: g, reject: B }),
            C.postMessage({
              type: Cg,
              protocolVersion: NA,
              invocationId: h,
      ...
      I = (s) => {
        c ||
          (QA.error("[bps][officejs-sandbox] guest session failed", {
            invocationId: h,
            message: s,
          }),
          C.postMessage({
      ...
      w = (s) => {
        ...
        const g = s.data;
        if (
          (QA.info("[bps][officejs-sandbox] guest received port message", {
            invocationId: h,
            type:
              typeof g == "object" && g !== null && "type" in g
                ? g.type
                : typeof g,
          }),
          Ag(g))
        ) {
          if (g.invocationId !== h || g.nonce !== G) {
            I(
              "run_officejs sandbox received a sync response for the wrong invocation.",
            );
            return;
          }
          const B = A.get(g.payload.requestId);
          if (!B) {
            I("run_officejs sandbox received an unexpected sync response id.");
            return;
          }
          (A.delete(g.payload.requestId), B.resolve(g.payload));
          return;
        }
        if (Ig(g)) {
          if (g.invocationId !== h || g.nonce !== G) {
            I(
              "run_officejs sandbox received a run request for the wrong invocation.",
            );
            return;
          }
          if (N) {
            I("run_officejs sandbox received a duplicate run request.");
            return;
          }
          ((N = !0),
            QA.info("[bps][officejs-sandbox] guest received run request", {
              invocationId: h,
              timeoutMs: g.limits.timeoutMs,
            }),
            k(g.script, { hostCall: a, limits: g.limits }).then(
              (B) => {
                c ||
                  (QA.info("[bps][officejs-sandbox] guest run completed", {
                    invocationId: h,
              ...
              (B) => {
                c ||
                  (QA.error("[bps][officejs-sandbox] guest run failed", {
                    invocationId: h,
        ...
        I("run_officejs sandbox received an invalid port message.");
      },
      Q = () => {
        var s;
        if (!c) {
          ((c = !0), C.removeEventListener("message", w));
          for (const g of A.values())
            g.reject(new Error("run_officejs sandbox session was disposed."));
          (A.clear(), (s = C.close) == null || s.call(C));
        }
      };
    return (
      C.addEventListener("message", w),
      (D = C.start) == null || D.call(C),
      QA.info("[bps][officejs-sandbox] guest port session attached", {
        invocationId: h,
      }),
      C.postMessage({
        type: $I,
  ...
  QA.info("[bps][officejs-sandbox] guest sandbox entry loaded");
  Hg();
});
export default rg();
